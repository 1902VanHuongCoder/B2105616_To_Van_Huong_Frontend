<template>  
  <Form @submit="submitContact" :validation-schema="contactFormSchema">  
    ...
    <div class="form-group">  
      ...
      <button v-bind:id="contactLocal._id" type="button" class="ml-2 btn btn-danger" @click="deleteContact">  
        Xóa  
      </button>  
  ...
  data() {  
    const contactFormSchema = yup.object().shape({  
      ...
      email: yup  
        ...
        .max(60, "E-mail tối đa 60 ký tự."),  
      address: yup.string().max(100, "Địa chỉ tối đa 100 ký tự."),  
      phone: yup  
        .string()  
        .matches(/^(0[0-9]{1}|[0-9]{2})[0-9]{8}$/, "Số điện thoại không hợp lệ."),  
    });  

    return {  
      // Chúng ta không muốn hiểu chính props, nên tạo biến cục bộ  
